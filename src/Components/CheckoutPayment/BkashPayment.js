...
const BkashPayment = ({ method, order }) => {
  const [bkashNumber, setBkashNumber] = useState("01734404040");
  const [rocketNumber, setRocketNumber] = useState("01734404040");
  const [nagadNumber, setNagadNumber] = useState("01716410101");
