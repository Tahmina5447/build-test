              ...
              {product?.size?.length >= 1 && (
                <div className="block md:flex  items-center">
                  ...
                  <div
                    ...
                    className={`mx-1 border items-center justify-center rounded-md font-bold bg-[#000] text-white cursor-pointer flex gap-2 p-1 text-xs `}
                  >
            ...
            <div>
              {product?.productColor.length > 0 && (
                <div className="block md:flex  items-center">
                  ...
                  <span
                    onClick={handleSizeAndColorWithModal}
                    className="w-6 h-6 block rounded-full ml-2"
