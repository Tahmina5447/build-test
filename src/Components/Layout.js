...
function Layout({ children }) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      gtmScript.innerHTML = `
        ...
        })(window,document,'script','dataLayer','GTM-5M2KXP7H');
      `;
      document.head.appendChild(gtmScript);

      const gtmNoScript = document.createElement('noscript');
      gtmNoScript.innerHTML = `
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5M2KXP7H"
  ...
  return (
    <>
      ...
      <main className="bg-[#F9FAFB] pb-[20px]">{children}</main>
